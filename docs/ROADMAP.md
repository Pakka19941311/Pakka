...
> С 2026-09-04 актуальный план — [COMMERCIAL_ROADMAP.md](COMMERCIAL_ROADMAP.md).
> Ниже сохранён исторический roadmap v0.3/v0.4; он не разрешает переход между новыми блоками без пользовательского теста.

## Текущий статус — 2026-09-03

- Стабильная точка v0.3 сохранена в ветке `checkpoint/v0.3-stable`.
- v0.4 Phase 1 завершён: third-person камера, camera-relative WASD, click-to-move, явный target и управляемое combat pursuit.
...
- Phase 2 не начинался и требует отдельного задания геймдиректора.
