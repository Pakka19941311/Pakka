export const CLASSES = {
  knight: { name:'Рыцарь', title:'Несокрушимый авангард', model:'Warrior', color:0xcda15d, resource:'Ярость', ranged:false, hp:310, mp:100, stats:{str:12,dex:5,int:2,vit:14,spi:4}, weapon:'wardens_blade', armor:'militia_plate', skills:[
  ...
  mage: { name:'Маг', title:'Повелитель стихий', model:'Wizard', color:0x649dff, resource:'Мана', ranged:true, hp:175, mp:340, stats:{str:2,dex:5,int:15,vit:6,spi:13}, weapon:'ember_staff', armor:'oracle_robe', skills:[
  ...
  assassin: { name:'Ассасин', title:'Клинок из сумрака', model:'Rogue', color:0xbe70e8, resource:'Энергия', ranged:false, hp:215, mp:180, stats:{str:8,dex:16,int:3,vit:8,spi:4}, weapon:'bone_fangs', armor:'night_leather', skills:[
  ...
  ranger: { name:'Рейнджер', title:'Охотник дальних земель', model:'Ranger', color:0x71c77c, resource:'Концентрация', ranged:true, hp:230, mp:200, stats:{str:6,dex:15,int:3,vit:9,spi:5}, weapon:'blackwood_bow', armor:'tracker_coat', skills:[
  ...
  necro: { name:'Некромант', title:'Владыка запретного ритуала', model:'Monk', color:0x5bd6b1, resource:'Эссенция', ranged:true, hp:205, mp:300, stats:{str:3,dex:5,int:13,vit:8,spi:15}, weapon:'mourn_grimoire', armor:'bone_raiment', skills:[
...
export const ENHANCE=[1,1,1,.70,.60,.50,.40,.32,.25,.19,.14,.10,.07,.05,.03];
