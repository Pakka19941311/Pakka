...
export const CLASSES = {
  ...
  mage: { name:'Маг', title:'Повелитель стихий', model:'Wizard', color:0x649dff, resource:'Мана', ranged:true, hp:270, mp:454, stats:{str:3,dex:7,int:15,vit:6,spi:13}, weapon:'ember_staff', armor:'oracle_robe', skills:[
    {name:'Огненная стрела',icon:'✦',cost:22,cd:3.5,mul:1.75,fx:'fire'}, {name:'Ледяное копьё',icon:'❄',cost:32,cd:7,mul:1.5,slow:3,fx:'ice'}, {name:'Цепная молния',icon:'ϟ',cost:48,cd:12,mul:1.35,chain:5,fx:'lightning'}, {name:'Морозное кольцо',icon:'◉',cost:60,cd:22,mul:1.1,aoe:5,fx:'ice'}]},
