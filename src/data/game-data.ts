...
export const ITEMS = {
  wardens_blade:{name:'Меч северного дозора',slot:'weapon',icon:'⚔',atk:[12,18],accuracy:1,value:140,origin:'Оружейная Астерхолда'}, ember_staff:{name:'Посох тлеющего камня',slot:'weapon',icon:'ϟ',matk:22,accuracy:1,value:140,origin:'Архив Серого круга'}, bone_fangs:{name:'Парные костяные клинки',slot:'weapon',icon:'†',atk:[10,16],crit:5,accuracy:2,value:140,origin:'Катакомбы границы'}, blackwood_bow:{name:'Лук Чёрного леса',slot:'weapon',icon:'➶',atk:[11,18],accuracy:7,value:140,origin:'Лесная застава'}, mourn_grimoire:{name:'Гримуар Последнего вздоха',slot:'weapon',icon:'▣',matk:24,spirit:3,accuracy:2,value:140,origin:'Склеп Безымянных'},
  ...
  executioner:{name:'Клинок Палача',slot:'weapon',icon:'⚔',atk:[31,44],crit:6,accuracy:10,value:2100,origin:'Кровавый Оборотень'}, rotten_root:{name:'Посох Гнилого Корня',slot:'weapon',icon:'♠',matk:54,mp:90,accuracy:10,value:2600,origin:'Хозяин Гнилого Леса'}, dead_king_plate:{name:'Панцирь Мёртвого Короля',slot:'chest',icon:'▦',def:31,mdef:18,hp:120,value:2900,origin:'Хозяин Гнилого Леса'}, sovereign_seal:{name:'Печать древнего владыки',slot:'neck',icon:'☼',atk:[8,11],matk:13,hp:60,value:3200,origin:'Хозяин Гнилого Леса'},
...
export const MONSTERS = {
  ...
  undead:{name:'Безымянный мертвец',model:'Skeleton',level:4,hp:155,atk:18,xp:70,gold:[9,18],tint:0xb5ad95,scale:.78,drops:[['black_bone',.72],['grave_boots',.027]]},
  ...
  wraith:{name:'Болотный призрак',model:'Monk',level:8,hp:210,atk:31,xp:158,gold:[20,38],tint:0x4bc2a2,scale:.9,drops:[['ether',.19],['oracle_robe',.014]]},
  mini:{name:'Кровавый Оборотень',model:'Fox',level:10,hp:1750,atk:43,xp:1100,gold:[180,290],tint:0xb52f32,scale:1.45,boss:'mini',drops:[['fallen_helm',.55],['fang_necklace',.65],['executioner',.22]]},
  big:{name:'Хозяин Гнилого Леса',model:'Dragon',level:14,hp:6200,atk:64,xp:3900,gold:[650,950],tint:0x477943,scale:1.45,boss:'big',drops:[['boss_seal',1],['rotten_root',.4],['dead_king_plate',.32],['sovereign_seal',.22]]}
};
