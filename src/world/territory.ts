...
export const SERVICES = {
  'npc:alchemist':{name:'Алхимик Мира',model:'Monk',x:8,z:-12,role:'Алхимия',merchantRole:'alchemist',tradeCity:'L02'},
  ...
  'npc:asterhold:smith':{name:'Кузнец Ульф',model:'Warrior',x:-117,z:-81,role:'Кузница',merchantRole:'weapon_vendor',tradeCity:'L01'},
  'npc:asterhold:teleport':{name:'Хранитель Ивен',model:'Wizard',x:-93,z:-84,role:'Переход'},
  'npc:asterhold:alchemist':{name:'Алхимик Селин',model:'Monk',x:-109,z:-88,role:'Алхимия',merchantRole:'alchemist',tradeCity:'L01'},
  ...
  'npc:smith':{name:'Кузнец Бран',model:'Warrior',x:-12,z:7,role:'Кузница',merchantRole:'weapon_vendor',tradeCity:'L02'},
