...
`, stage, archive, epoch]);
  ...
  const result = { sourceCommit: commit, release: release.html_url, download, bytes, sha256: checksum, qaScope: 'knight-integration', nativeGodotGraphicsLinuxPassed: true, nativeWindowsHeadlessPassed: true, windowsGpuVerified: false, directDownloadVerified: true, nativeSourceArchiveIncluded: existsSync(sourceArchive) };
