...
if (options.includes('--stage')) {
  ...
  for (let skill = 0; skill < 4; skill += 1) {
    assert.equal(windows.native.checks[`skill_${skill}_real_animation`], true, `Shipped Windows must observe the real animation for knight skill ${skill}`);
  }
