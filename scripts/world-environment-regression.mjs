...
const report={block:castle?'part1-castle-checkpoint':'part1-environment-checkpoint',sha:process.env.GITHUB_SHA??'local',passed:false,checks:[],errors:[],
...
try{
  ...
  for(const view of castle?['gate','courtyard','capital']:['gate','forest','rocks']){
