...
camera.rotation_euler=(center-camera.location).to_track_quat('-Z','Y').to_euler();camera.data.type='ORTHO';camera.data.ortho_scale=height*1.22;scene.camera=camera
...
for name,fraction in [('Idle',.25),('Walk',.5),('Attack',.5),('Death',.75)]:
